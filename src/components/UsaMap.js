...
const statePositions = {'US': {scale: 1, x: 0, y: 0}, 'CA': {scale: 2.2, x: 0.3, y: 0}, 'AK': {scale: 4, x: 0.3, y: -0.18},'AL':{'scale':1,'x':0,'y':0},'AZ':{'scale':1,'x':0,'y':0},'AR':{'scale':1,'x':0,'y':0},'CO':{'scale':4,'x':0.125,'y':0.01},'CT':{'scale':1,'x':0,'y':0},'DE':{'scale':10,'x':-0.28,'y':0.035},'DC':{'scale':1,'x':0,'y':0},'FL':{'scale':1,'x':0,'y':0},'GA':{'scale':5.5,'x':-0.19,'y':-0.09},'HI':{'scale':7,'x':0.16,'y':-0.2},'ID':{'scale':1,'x':0,'y':0},'IL':{'scale':4,'x':-0.09,'y':0.02},'IN':{'scale':5,'x':-0.13,'y':0.03},'IA':{'scale':7,'x':-0.04,'y':0.06},'KS':{'scale':6,'x':0.025,'y':-0.005},'KY':{'scale':7,'x':-0.15,'y':-0.01},'LA':{'scale':1,'x':0,'y':0},'ME':{'scale':1,'x':0,'y':0},'MD':{'scale':1,'x':0,'y':0},'MA':{'scale':1,'x':0,'y':0},'MI':{'scale':4,'x':-0.13,'y':0.1},'MN':{'scale':4,'x':-0.02,'y':0.14},'MS':{'scale':5,'x':-0.095,'y':-0.102},'MO':{'scale':5,'x':-0.055,'y':-0.008},'MT':{'scale':1,'x':0,'y':0},'NE':{'scale':5,'x':0.04,'y':0.05},'NV':{'scale':1,'x':0,'y':0},'NH':{'scale':1,'x':0,'y':0},'NJ':{'scale':1,'x':0,'y':0},'NM':{'scale':1,'x':0,'y':0},'NY':{'scale':5,'x':-0.27,'y':0.105},'NC':{'scale':5,'x':-0.23,'y':-0.04},'ND':{'scale':1,'x':0,'y':0},'OH':{'scale':1,'x':0,'y':0},'OK':{'scale':5,'x':0.02,'y':-0.06},'OR':{'scale':4.5,'x':0.3,'y':0.13},'PA':{'scale':1,'x':0,'y':0},'RI':{'scale':14,'x':-0.318,'y':0.093},'SC':{'scale':6,'x':-0.22,'y':-0.07},'SD':{'scale':1,'x':0,'y':0},'TN':{'scale':1,'x':0,'y':0},'TX':{'scale':1,'x':0,'y':0},'UT':{'scale':4,'x':0.2,'y':0.03},'VT':{'scale':1,'x':0,'y':0},'VA':{'scale':1,'x':0,'y':0},'WA':{'scale':6,'x':0.28,'y':0.19},'WV':{'scale':1,'x':0,'y':0},'WI':{'scale':5,'x':-0.08,'y':0.11},'WY':{'scale':1,'x':0,'y':0}};
  ...
  return (
    <>
      ...
      <svg style={{ height, width: isSmallViewport ? width : mapWidth, display: isSmallViewport ? 'block' : 'inline-block' }} fill="none" aria-describedby="main-data-table">
        <CustomProjection data={countyTopo} scale={scaleFactor} translate={[(isSmallViewport ? width : mapWidth) / 2 + (scaleFactor * statePosition.x), halfHeight + (scaleFactor * statePosition.y)]} projection={geoAlbersUsaTerritories}>
          {({ features, projection }) => constructGeoJsx(features, projection)}
        </CustomProjection>
        <CustomProjection data={stateTopo} scale={scaleFactor} translate={[(isSmallViewport ? width : mapWidth) / 2 + (scaleFactor * statePosition.x), halfHeight + (scaleFactor * statePosition.y)]} projection={geoAlbersUsaTerritories}>
