  ...
  return (
    <>
      ...
      <small>
        ...
        <br /><p>States that submitted revised data that include the cannabis codes, thus not impacted by this issue, include: Alaska, Hawaii, Iowa, Indiana, Kentucky, Nebraska, New York, North Carolina, Rhode Island, and Washington.</p>
      </small>
